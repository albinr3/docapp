...
const MyAppointmentDetail = ({ navigation }) => {
  /**
    * Render Header
    */
  const renderHeader = () => {
  ...
  const renderContent = () => {
    return (
      <View style={{ marginBottom: 100 }}>
        ...
        <Text style={styles.mediumTitle}>Scheduled Appointment</Text>
        <View>
        ...
        <View style={styles.separateLine} />
        <Text style={styles.mediumTitle}>Patient Info.</Text>
        <View>
          <View style={styles.reviewItemContainer}>
            <Text style={styles.reviewItemLeft}>Full Name</Text>
            <Text style={styles.reviewItemRight}>Esther Howard</Text>
          </View>
          <View style={styles.reviewItemContainer}>
            <Text style={styles.reviewItemLeft}>Gender</Text>
            <Text style={styles.reviewItemRight}>Male</Text>
          </View>
          <View style={styles.reviewItemContainer}>
            <Text style={styles.reviewItemLeft}>Age</Text>
            <Text style={styles.reviewItemRight}>27</Text>
          </View>
          <View style={styles.reviewItemContainer}>
            <Text style={styles.reviewItemLeft}>Problem</Text>
            <Text style={styles.reviewItemRight}>Lorem ipsum dolor</Text>
          </View>
        </View>
        <View style={styles.separateLine} />
        <View style={styles.reviewItemContainer}>
          <View style={{
            ...
            <Text style={[styles.reviewItemLeft, { marginLeft: 6 }]}>Paid</Text>
          </View>
        </View>
      </View>
    )
